...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
        ...
        if (writtenByYourself) {
        	System.out.println("The Code Assignment is Written By Myself");
        }
        
        if (availableToOthers) {
        	System.out.println("The Code Assignment is Available to Others");
        }
        
        if (writtenAsCourseWork) {
        	System.out.println("The Code Assignment is Written As Course Work");
        }
        
        if (citingYourSource) {
        	System.out.println("The Code Assignment is Citing your source");
        }
        
        if (implementationRequired) {
        	System.out.println("The Code Assignment has Implementation Required");
        }
